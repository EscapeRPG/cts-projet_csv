 ...
 */
final class Version20260211104032 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE clients_factures (id INT AUTO_INCREMENT NOT NULL, idclient INT NOT NULL, idfacture INT NOT NULL, montant_presta_ht NUMERIC(10, 2) NOT NULL, data_date DATE NOT NULL, agr_centre VARCHAR(20) DEFAULT NULL, PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP TABLE clients_factures');
