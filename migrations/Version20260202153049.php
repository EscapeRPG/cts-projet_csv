 ...
 */
final class Version20260202153049 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE user ADD activation_token VARCHAR(255) DEFAULT NULL, ADD is_active TINYINT NOT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE user DROP activation_token, DROP is_active');
    }
}
