 ...
 */
final class Version20260402080747 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE voiture (id INT AUTO_INCREMENT NOT NULL, immatriculation VARCHAR(20) NOT NULL, marque VARCHAR(20) NOT NULL, couleur VARCHAR(20) DEFAULT NULL, modele VARCHAR(50) DEFAULT NULL, flocable TINYINT DEFAULT NULL, annee DATE DEFAULT NULL, controle_technique DATE DEFAULT NULL, km VARCHAR(50) DEFAULT NULL, prix NUMERIC(10, 2) DEFAULT NULL, carte_grise VARCHAR(10) DEFAULT NULL, lieu VARCHAR(50) DEFAULT NULL, utilisateur VARCHAR(255) DEFAULT NULL, remarques VARCHAR(255) DEFAULT NULL, societe_id INT NOT NULL, centre_id INT DEFAULT NULL, INDEX IDX_E9E2810FFCF77503 (societe_id), INDEX IDX_E9E2810F463CD7C3 (centre_id), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE synthese_controles (id INT AUTO_INCREMENT NOT NULL, societe_nom VARCHAR(255) CHARACTER SET utf8mb4 NOT NULL COLLATE `utf8mb4_0900_ai_ci`, agr_centre VARCHAR(50) CHARACTER SET utf8mb4 NOT NULL COLLATE `utf8mb4_0900_ai_ci`, agr_centre_cl VARCHAR(50) CHARACTER SET utf8mb4 DEFAULT \'\' NOT NULL COLLATE `utf8mb4_0900_ai_ci`, centre_ville VARCHAR(255) CHARACTER SET utf8mb4 DEFAULT \'\' COLLATE `utf8mb4_0900_ai_ci`, reseau_id INT NOT NULL, reseau_nom VARCHAR(50) CHARACTER SET utf8mb4 DEFAULT \'\' COLLATE `utf8mb4_0900_ai_ci`, salarie_id INT NOT NULL, salarie_agr VARCHAR(20) CHARACTER SET utf8mb4 NOT NULL COLLATE `utf8mb4_0900_ai_ci`, salarie_agr_cl VARCHAR(20) CHARACTER SET utf8mb4 DEFAULT \'\' NOT NULL COLLATE `utf8mb4_0900_ai_ci`, salarie_nom VARCHAR(255) CHARACTER SET utf8mb4 NOT NULL COLLATE `utf8mb4_0900_ai_ci`, salarie_prenom VARCHAR(255) CHARACTER SET utf8mb4 NOT NULL COLLATE `utf8mb4_0900_ai_ci`, annee INT NOT NULL, mois INT NOT NULL, nb_controles INT DEFAULT 0 NOT NULL, nb_controles_factures INT DEFAULT 0 NOT NULL, nb_vtp INT DEFAULT 0 NOT NULL, nb_vtp_factures INT DEFAULT 0 NOT NULL, nb_vtp_particuliers INT DEFAULT 0 NOT NULL, nb_vtp_professionnels INT DEFAULT 0 NOT NULL, nb_clvtp INT DEFAULT 0 NOT NULL, nb_clvtp_factures INT DEFAULT 0 NOT NULL, nb_clvtp_particuliers INT DEFAULT 0 NOT NULL, nb_clvtp_professionnels INT DEFAULT 0 NOT NULL, nb_cv INT DEFAULT 0 NOT NULL, nb_cv_factures INT DEFAULT 0 NOT NULL, nb_cv_particuliers INT DEFAULT 0 NOT NULL, nb_cv_professionnels INT DEFAULT 0 NOT NULL, nb_clcv INT DEFAULT 0 NOT NULL, nb_clcv_factures INT DEFAULT 0 NOT NULL, nb_clcv_particuliers INT DEFAULT 0 NOT NULL, nb_clcv_professionnels INT DEFAULT 0 NOT NULL, nb_vtc INT DEFAULT 0 NOT NULL, nb_vtc_factures INT DEFAULT 0 NOT NULL, nb_vtc_particuliers INT DEFAULT 0 NOT NULL, nb_vtc_professionnels INT DEFAULT 0 NOT NULL, nb_vol INT DEFAULT 0 NOT NULL, nb_vol_factures INT DEFAULT 0 NOT NULL, nb_vol_particuliers INT DEFAULT 0 NOT NULL, nb_vol_professionnels INT DEFAULT 0 NOT NULL, nb_clvol INT DEFAULT 0 NOT NULL, nb_clvol_factures INT DEFAULT 0 NOT NULL, nb_clvol_particuliers INT DEFAULT 0 NOT NULL, nb_clvol_professionnels INT DEFAULT 0 NOT NULL, nb_auto INT DEFAULT 0 NOT NULL, nb_auto_factures INT DEFAULT 0 NOT NULL, nb_moto INT DEFAULT 0 NOT NULL, nb_moto_factures INT DEFAULT 0 NOT NULL, total_presta_ht NUMERIC(12, 2) DEFAULT \'0.00\' NOT NULL, total_presta_ht_particuliers NUMERIC(12, 2) DEFAULT \'0.00\' NOT NULL, total_presta_ht_professionnels NUMERIC(12, 2) DEFAULT \'0.00\' NOT NULL, total_ht_vtp NUMERIC(12, 2) DEFAULT \'0.00\' NOT NULL, total_ht_vtp_particuliers NUMERIC(12, 2) DEFAULT \'0.00\' NOT NULL, total_ht_vtp_professionnels NUMERIC(12, 2) DEFAULT \'0.00\' NOT NULL, total_ht_clvtp NUMERIC(12, 2) DEFAULT \'0.00\' NOT NULL, total_ht_clvtp_particuliers NUMERIC(12, 2) DEFAULT \'0.00\' NOT NULL, total_ht_clvtp_professionnels NUMERIC(12, 2) DEFAULT \'0.00\' NOT NULL, total_ht_cv NUMERIC(12, 2) DEFAULT \'0.00\' NOT NULL, total_ht_cv_particuliers NUMERIC(12, 2) DEFAULT \'0.00\' NOT NULL, total_ht_cv_professionnels NUMERIC(12, 2) DEFAULT \'0.00\' NOT NULL, total_ht_clcv NUMERIC(12, 2) DEFAULT \'0.00\' NOT NULL, total_ht_clcv_particuliers NUMERIC(12, 2) DEFAULT \'0.00\' NOT NULL, total_ht_clcv_professionnels NUMERIC(12, 2) DEFAULT \'0.00\' NOT NULL, total_ht_vtc NUMERIC(12, 2) DEFAULT \'0.00\' NOT NULL, total_ht_vtc_particuliers NUMERIC(12, 2) DEFAULT \'0.00\' NOT NULL, total_ht_vtc_professionnels NUMERIC(12, 2) DEFAULT \'0.00\' NOT NULL, total_ht_vol NUMERIC(12, 2) DEFAULT \'0.00\' NOT NULL, total_ht_vol_particuliers NUMERIC(12, 2) DEFAULT \'0.00\' NOT NULL, total_ht_vol_professionnels NUMERIC(12, 2) DEFAULT \'0.00\' NOT NULL, total_ht_clvol NUMERIC(12, 2) DEFAULT \'0.00\' NOT NULL, total_ht_clvol_particuliers NUMERIC(12, 2) DEFAULT \'0.00\' NOT NULL, total_ht_clvol_professionnels NUMERIC(12, 2) DEFAULT \'0.00\' NOT NULL, temps_total INT DEFAULT 0 NOT NULL, temps_total_auto INT DEFAULT 0 NOT NULL, temps_total_moto INT DEFAULT 0 NOT NULL, temps_total_vtp INT DEFAULT 0 NOT NULL, temps_total_clvtp INT DEFAULT 0 NOT NULL, temps_total_cv INT DEFAULT 0 NOT NULL, temps_total_clcv INT DEFAULT 0 NOT NULL, temps_total_vtc INT DEFAULT 0 NOT NULL, temps_total_vol INT DEFAULT 0 NOT NULL, temps_total_clvol INT DEFAULT 0 NOT NULL, taux_refus NUMERIC(5, 2) DEFAULT \'0.00\' NOT NULL, refus_auto INT DEFAULT 0 NOT NULL, refus_moto INT DEFAULT 0 NOT NULL, refus_vtp INT DEFAULT 0 NOT NULL, refus_clvtp INT DEFAULT 0 NOT NULL, refus_cv INT DEFAULT 0 NOT NULL, refus_clcv INT DEFAULT 0 NOT NULL, refus_vtc INT DEFAULT 0 NOT NULL, refus_vol INT DEFAULT 0 NOT NULL, refus_clvol INT DEFAULT 0 NOT NULL, nb_particuliers INT DEFAULT 0 NOT NULL, nb_professionnels INT DEFAULT 0 NOT NULL, nb_particuliers_auto INT DEFAULT 0 NOT NULL, nb_particuliers_moto INT DEFAULT 0 NOT NULL, nb_professionnels_auto INT DEFAULT 0 NOT NULL, nb_professionnels_moto INT DEFAULT 0 NOT NULL, INDEX idx_sc_filter_dimensions (annee, mois, reseau_id, societe_nom, agr_centre, salarie_id), INDEX idx_sc_filter_dimensions_by_name (annee, mois, reseau_nom, societe_nom, agr_centre, salarie_id), INDEX idx_sc_societe_centre_salarie (societe_nom, agr_centre, salarie_id), INDEX idx_synthese_periode (annee, mois), UNIQUE INDEX unique_salarie_mois_annee (salarie_id, salarie_agr, agr_centre, annee, mois), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_0900_ai_ci` ENGINE = InnoDB COMMENT = \'\' ');
