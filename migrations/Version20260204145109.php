 ...
 */
final class Version20260204145109 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE salaries CHANGE is_active is_active TINYINT DEFAULT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE salaries CHANGE is_active is_active TINYINT NOT NULL');
    }
}
