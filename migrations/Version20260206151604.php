 ...
 */
final class Version20260206151604 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE controles CHANGE date_ctrl date_ctrl DATE NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE controles CHANGE date_ctrl date_ctrl DATETIME NOT NULL');
