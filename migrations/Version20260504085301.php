 ...
 */
final class Version20260504085301 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE holding (id INT AUTO_INCREMENT NOT NULL, nom VARCHAR(255) NOT NULL, PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4');
        $this->addSql('CREATE TABLE holding_societe (holding_id INT NOT NULL, societe_id INT NOT NULL, INDEX IDX_EB8AF6346CD5FBA3 (holding_id), INDEX IDX_EB8AF634FCF77503 (societe_id), PRIMARY KEY (holding_id, societe_id)) DEFAULT CHARACTER SET utf8mb4');
        $this->addSql('ALTER TABLE holding_societe ADD CONSTRAINT FK_EB8AF6346CD5FBA3 FOREIGN KEY (holding_id) REFERENCES holding (id) ON DELETE CASCADE');
        $this->addSql('ALTER TABLE holding_societe ADD CONSTRAINT FK_EB8AF634FCF77503 FOREIGN KEY (societe_id) REFERENCES societe (id) ON DELETE CASCADE');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP TABLE holding_societe');
