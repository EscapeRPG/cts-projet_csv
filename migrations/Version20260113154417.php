 ...
 */
final class Version20260113154417 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE clients ADD id INT AUTO_INCREMENT NOT NULL, CHANGE idclient idclient BIGINT NOT NULL, DROP PRIMARY KEY, ADD PRIMARY KEY (id)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE clients DROP id, CHANGE idclient idclient BIGINT AUTO_INCREMENT NOT NULL, DROP PRIMARY KEY, ADD PRIMARY KEY (idclient)');
