 ...
 */
final class Version20260505114944 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE encours_bancaire ADD montant NUMERIC(10, 2) DEFAULT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE encours_bancaire DROP montant');
