 ...
 */
final class Version20260202150137 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE reglements DROP data_date');
        $this->addSql('ALTER TABLE reglements ADD CONSTRAINT FK_648F2671445D170C FOREIGN KEY (reseau_id) REFERENCES reseau (id)');
        $this->addSql('ALTER TABLE user ADD secret_question VARCHAR(255) DEFAULT NULL, ADD secret_answer VARCHAR(255) DEFAULT NULL, ADD has_secret_question TINYINT NOT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE centres_clients ADD data_date DATE DEFAULT NULL');
        $this->addSql('ALTER TABLE clients DROP FOREIGN KEY FK_C82E74445D170C');
        $this->addSql('ALTER TABLE clients ADD data_date DATE DEFAULT NULL');
        $this->addSql('ALTER TABLE clients_controles DROP FOREIGN KEY FK_E0443B21445D170C');
        $this->addSql('ALTER TABLE clients_controles ADD data_date DATE DEFAULT NULL');
        $this->addSql('ALTER TABLE controles DROP FOREIGN KEY FK_B10ABA6D445D170C');
        $this->addSql('ALTER TABLE controles ADD data_date DATE DEFAULT NULL');
        $this->addSql('ALTER TABLE controles_factures DROP FOREIGN KEY FK_B77B2F69445D170C');
        $this->addSql('ALTER TABLE controles_factures ADD data_date DATE DEFAULT NULL');
        $this->addSql('ALTER TABLE controles_non_factures DROP FOREIGN KEY FK_76FCF60E445D170C');
        $this->addSql('ALTER TABLE controles_non_factures ADD data_date DATE DEFAULT NULL');
        $this->addSql('ALTER TABLE factures DROP FOREIGN KEY FK_647590B445D170C');
        $this->addSql('ALTER TABLE factures ADD data_date DATE DEFAULT NULL');
        $this->addSql('ALTER TABLE factures_reglements DROP FOREIGN KEY FK_1D789B86445D170C');
        $this->addSql('ALTER TABLE factures_reglements ADD data_date DATE DEFAULT NULL');
        $this->addSql('ALTER TABLE imported_files DROP FOREIGN KEY FK_D8475CB7445D170C');
        $this->addSql('ALTER TABLE imported_files ADD file_date DATE DEFAULT NULL');
        $this->addSql('ALTER TABLE prestas_non_facturees DROP FOREIGN KEY FK_6E23438D445D170C');
        $this->addSql('ALTER TABLE prestas_non_facturees ADD data_date DATE DEFAULT NULL');
        $this->addSql('ALTER TABLE reglements DROP FOREIGN KEY FK_648F2671445D170C');
        $this->addSql('ALTER TABLE reglements ADD data_date DATE DEFAULT NULL');
        $this->addSql('ALTER TABLE user DROP secret_question, DROP secret_answer, DROP has_secret_question');
    }
}
