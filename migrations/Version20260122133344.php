 ...
 */
final class Version20260122133344 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE centre CHANGE telephone telephone VARCHAR(20) DEFAULT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE centre CHANGE telephone telephone VARCHAR(12) DEFAULT NULL');
