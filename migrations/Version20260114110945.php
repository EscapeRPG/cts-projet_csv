 ...
 */
final class Version20260114110945 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE imported_files (id INT AUTO_INCREMENT NOT NULL, filename VARCHAR(150) NOT NULL, imported_at DATETIME NOT NULL, UNIQUE INDEX UNIQ_D8475CB73C0BE965 (filename), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4');
        ...
        $this->addSql('ALTER TABLE controles CHANGE date_prise_rdv date_prise_rdv DATETIME NOT NULL, CHANGE deb_ctrl deb_ctrl DATETIME NOT NULL, CHANGE fin_ctrl fin_ctrl DATETIME NOT NULL, CHANGE date_ctrl date_ctrl DATETIME NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE controles CHANGE date_prise_rdv date_prise_rdv DATETIME DEFAULT NULL, CHANGE deb_ctrl deb_ctrl TIME NOT NULL, CHANGE fin_ctrl fin_ctrl TIME NOT NULL, CHANGE date_ctrl date_ctrl DATE NOT NULL');
