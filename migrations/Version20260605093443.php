 ...
 */
final class Version20260605093443 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE controles CHANGE num_serie_vehicule num_serie_vehicule VARCHAR(50) DEFAULT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE controles CHANGE num_serie_vehicule num_serie_vehicule VARCHAR(12) DEFAULT NULL');
