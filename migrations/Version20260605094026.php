 ...
 */
final class Version20260605094026 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE controles CHANGE annee_circulation annee_circulation VARCHAR(20) DEFAULT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE controles CHANGE annee_circulation annee_circulation INT DEFAULT NULL');
