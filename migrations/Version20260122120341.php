...
final class Version20260122120341 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('DROP INDEX UNIQ_828E3A1A77153098 ON salaries');
        $this->addSql('ALTER TABLE salaries CHANGE code agr_controleur VARCHAR(50) DEFAULT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE salaries CHANGE agr_controleur code VARCHAR(50) DEFAULT NULL');
        $this->addSql('CREATE UNIQUE INDEX UNIQ_828E3A1A77153098 ON salaries (code)');
    }
}
