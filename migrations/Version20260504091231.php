 ...
 */
final class Version20260504091231 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE holding_societe ADD id INT AUTO_INCREMENT NOT NULL, ADD pourcentage NUMERIC(5, 2) NOT NULL, CHANGE holding_id holding_id INT DEFAULT NULL, CHANGE societe_id societe_id INT DEFAULT NULL, DROP PRIMARY KEY, ADD PRIMARY KEY (id)');
        $this->addSql('ALTER TABLE holding_societe ADD CONSTRAINT FK_EB8AF6346CD5FBA3 FOREIGN KEY (holding_id) REFERENCES holding (id)');
        $this->addSql('ALTER TABLE holding_societe ADD CONSTRAINT FK_EB8AF634FCF77503 FOREIGN KEY (societe_id) REFERENCES societe (id)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE holding_societe DROP FOREIGN KEY FK_EB8AF6346CD5FBA3');
        $this->addSql('ALTER TABLE holding_societe DROP FOREIGN KEY FK_EB8AF634FCF77503');
        $this->addSql('ALTER TABLE holding_societe MODIFY id INT NOT NULL');
        $this->addSql('ALTER TABLE holding_societe DROP id, DROP pourcentage, CHANGE holding_id holding_id INT NOT NULL, CHANGE societe_id societe_id INT NOT NULL, DROP PRIMARY KEY, ADD PRIMARY KEY (holding_id, societe_id)');
