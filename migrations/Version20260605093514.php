 ...
 */
final class Version20260605093514 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE factures CHANGE type_facture type_facture VARCHAR(10) DEFAULT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE factures CHANGE type_facture type_facture VARCHAR(1) DEFAULT NULL');
