 ...
 */
final class Version20260206151455 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE controles CHANGE deb_ctrl deb_ctrl TIME NOT NULL, CHANGE fin_ctrl fin_ctrl TIME NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE controles CHANGE deb_ctrl deb_ctrl DATETIME NOT NULL, CHANGE fin_ctrl fin_ctrl DATETIME NOT NULL');
