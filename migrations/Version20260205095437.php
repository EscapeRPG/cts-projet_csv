 ...
 */
final class Version20260205095437 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE salarie ADD societe_id INT NOT NULL, DROP societe');
        $this->addSql('ALTER TABLE salarie ADD CONSTRAINT FK_828E3A1AFCF77503 FOREIGN KEY (societe_id) REFERENCES societe (id)');
        $this->addSql('CREATE INDEX IDX_828E3A1AFCF77503 ON salarie (societe_id)');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP INDEX IDX_828E3A1AFCF77503 ON salarie');
        $this->addSql('ALTER TABLE salarie ADD societe VARCHAR(255) NOT NULL, DROP societe_id');
    }
}
