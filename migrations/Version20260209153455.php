 ...
 */
final class Version20260209153455 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE affectation (id INT AUTO_INCREMENT NOT NULL, date_debut DATETIME DEFAULT NULL, date_fin DATETIME DEFAULT NULL, salarie_id INT NOT NULL, centre_id INT NOT NULL, UNIQUE INDEX uniq_salarie_centre (salarie_id, centre_id), INDEX IDX_F4DD61D35859934A (salarie_id), INDEX IDX_F4DD61D3463CD7C3 (centre_id), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_0900_ai_ci` ENGINE = MyISAM COMMENT = \'\' ');
