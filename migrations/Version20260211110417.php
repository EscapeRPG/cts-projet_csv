 ...
 */
final class Version20260211110417 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE clients_factures CHANGE idclient idclient BIGINT NOT NULL, CHANGE idfacture idfacture BIGINT NOT NULL, CHANGE montant_presta_ht montant_presta_ht NUMERIC(8, 2) NOT NULL, CHANGE agr_centre agr_centre VARCHAR(8) DEFAULT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE clients_factures CHANGE idclient idclient INT NOT NULL, CHANGE idfacture idfacture INT NOT NULL, CHANGE montant_presta_ht montant_presta_ht NUMERIC(10, 2) NOT NULL, CHANGE agr_centre agr_centre VARCHAR(20) DEFAULT NULL');
