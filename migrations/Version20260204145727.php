 ...
 */
final class Version20260204145727 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE salaries CHANGE nb_heures nb_heures NUMERIC(5, 2) DEFAULT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE salaries CHANGE nb_heures nb_heures INT DEFAULT NULL');
    }
}
