 ...
 */
final class Version20260203105732 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE factures ADD data_date DATE NOT NULL');
        $this->addSql('ALTER TABLE factures ADD CONSTRAINT FK_647590B445D170C FOREIGN KEY (reseau_id) REFERENCES reseau (id)');
        $this->addSql('ALTER TABLE factures_reglements ADD data_date DATE NOT NULL');
        ...
        $this->addSql('ALTER TABLE imported_files ADD data_date DATE NOT NULL');
        $this->addSql('ALTER TABLE imported_files ADD CONSTRAINT FK_D8475CB7445D170C FOREIGN KEY (reseau_id) REFERENCES reseau (id)');
        $this->addSql('ALTER TABLE prestas_non_facturees ADD data_date DATE NOT NULL');
        ...
        $this->addSql('ALTER TABLE reglements ADD data_date DATE NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE imported_files DROP data_date');
