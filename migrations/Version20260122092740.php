 ...
 */
final class Version20260122092740 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE societe ADD num_tva VARCHAR(20) DEFAULT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE centre DROP coordonnees, DROP telephone, DROP email, DROP site_web, DROP num_siret, CHANGE ville nom VARCHAR(255) NOT NULL');
        ...
        $this->addSql('ALTER TABLE societe DROP num_tva');
    }
}
