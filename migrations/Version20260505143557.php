 ...
 */
final class Version20260505143557 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE encours_montant (id INT AUTO_INCREMENT NOT NULL, montant NUMERIC(10, 2) NOT NULL, annee INT NOT NULL, encours_id INT NOT NULL, INDEX IDX_4ADEEF75B085AAD (encours_id), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4');
        ...
        $this->addSql('ALTER TABLE encours_bancaire DROP annee, DROP montant');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP TABLE encours_montant');
        $this->addSql('ALTER TABLE encours_bancaire DROP FOREIGN KEY FK_C4CD236BFCF77503');
        $this->addSql('ALTER TABLE encours_bancaire ADD annee INT NOT NULL, ADD montant NUMERIC(10, 2) DEFAULT NULL');
