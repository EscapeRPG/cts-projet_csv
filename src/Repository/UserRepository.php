...
class UserRepository extends ServiceEntityRepository implements PasswordUpgraderInterface
{
     ...
     *
     * @param PasswordAuthenticatedUserInterface $user User instance to update.
     * @param string $newHashedPassword Newly hashed password.
     *
     * @return void
     *
     * @throws UnsupportedUserException When the provided user implementation is not supported.
     */
